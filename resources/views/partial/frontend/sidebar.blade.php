<div class="wn__sidebar">
    ...
    <aside class="widget search_widget">
        ...
        {!! Form::open(['route' => 'frontend.search', 'method' => 'get']) !!}
            <div class="form-input">
                {!! Form::text('keyword', old('keyword', request('keyword')), ['placeholder' => 'Search....', 'id' => 'search']) !!}
            ...
            <li>
                <div class="post-wrapper">
                    ...
                    <div class="content">
                        ...
                        <a href="#">{{ Illuminate\support\Str::limit($recent_comment->comment, 20, '...') }}</a>
                    </div>
                </div>
            </li>
        @endforeach
    ...
    <aside class="widget archives_widget">
        ...
        <ul>
        @foreach($global_archives as $key => $value) <!--  $key->month,  $value->year  -->
