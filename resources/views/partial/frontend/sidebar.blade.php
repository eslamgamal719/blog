                ...
                @foreach($recent_posts as $recent_post)
                    <li>
                        <div class="post-wrapper d-flex">
                            <div class="thumb">
                                <a href="{{ route('frontend.post.show', $recent_post->slug) }}">
                            ...
                            <div class="content">
                                <h4><a href="{{ route('frontend.post.show', $recent_post->slug) }}">{{ \Illuminate\Support\Str::limit($recent_post->title, 15, '...') }}</a></h4>
