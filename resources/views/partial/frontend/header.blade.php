            ...
            <div class="col-lg-8 d-none d-lg-block">
                <nav class="mainmenu__nav">
                    <ul class="meninmenu d-flex justify-content-start">
                        ...
                        <li class="drop with--one--item"><a href="{{ route('frontend.post.show', 'about-us') }}">About Us</a></li>
                        <li class="drop with--one--item"><a href="{{ route('frontend.post.show', 'our-vision') }}">Our Vision</a></li>
            ...
            <div class="col-lg-12 d-none">
                <nav class="mobilemenu__nav">
                    <ul class="meninmenu">
                        ...
                        <li><a href="{{ route('frontend.post.show', 'about-us') }}">About Us</a></li>
                        <li><a href="{{ route('frontend.post.show', 'our-vision') }}">Our Vision</a></li>
